...
btn0 = Button(cal, padx = 16, pady = 16, bd = 8, fg = "black", font = ("arial", 20, "bold"), text = 0,
              bg = "lavender", command = lambda:btnClick(0)).grid(row = 4, column = 0)

btnClear = Button(cal, padx = 16, pady = 16, bd = 8, fg = "black", font = ("arial", 20, "bold"), text = "C",
                  bg = "lavender", command = lambda:btnClick(C)).grid(row = 4, column = 1)

btnEquals = Button(cal, padx = 16, pady = 16, bd = 8, fg = "black", font = ("arial", 20, "bold"), text = "=",
                   bg = "lavender", command = btnEqualsInput).grid(row = 4, column = 2)

Division = Button(cal, padx = 16, pady = 16, bd = 8, fg = "black", font = ("arial", 20, "bold"), text = "/",
                  bg = "lavender", command = lambda:btnClick("/")).grid(row = 4, column = 3)
